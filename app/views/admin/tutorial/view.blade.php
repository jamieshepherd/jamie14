        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="/admin/tutorial/edit/{{ $article->id }}" title="Edit"><i class="fa fa-pencil-square-o"></i></a>&nbsp;&nbsp;
                    <a href="/admin/tutorial/delete/{{ $article->id }}" title="Delete"><i class="fa fa-trash-o"></i></a>
                </td>
